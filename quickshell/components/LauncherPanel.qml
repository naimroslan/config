                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { text: "↑↓ nav"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "↵ launch"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "tab walls"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "esc close"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                        }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { text: "←→↑↓ nav"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "↵ apply"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "tab apps"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "esc close"; color: root.walColor8; font.pixelSize: 13; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                        }
                    }
