...
PanelWindow {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    id: powerRow
                    Layout.fillWidth: true
                    Layout.preferredHeight: confirmOverlay.visible ? 100 : 50
                    color: Qt.rgba(0, 0, 0, 0.3)
                    radius: 15
                    clip: true
                    Behavior on Layout.preferredHeight { NumberAnimation { duration: 200; easing.type: Easing.OutCubic } }
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            height: 50
                            spacing: 25
                            PowerBtn { icon: "⏻"; iconColor: root.walColor2; label: "Shutdown"; cmd: "systemctl poweroff"; needsConfirm: true }
                            PowerBtn { icon: "󰜉"; iconColor: root.walColor13; label: "Reboot"; cmd: "systemctl reboot"; needsConfirm: true }
                            PowerBtn { icon: "󰌾"; iconColor: root.walColor5; label: "Lock"; cmd: "hyprlock"; needsConfirm: false }
                            PowerBtn { icon: "󰒲"; iconColor: root.walColor4; label: "Suspend"; cmd: "systemctl suspend"; needsConfirm: true }
                            PowerBtn { icon: "󰍃"; iconColor: root.walColor1; label: "Logout"; cmd: "hyprctl dispatch exit"; needsConfirm: true }
                        }
                        Item {
                            id: confirmOverlay
                            width: parent.width
                            height: 50
                            visible: powerRow.pendingCmd !== ""
                            Row {
                                anchors.centerIn: parent
                                spacing: 15
                                Text {
                                    text: powerRow.pendingLabel + "?"
                                    color: root.walForeground
                                    font.pixelSize: 16
                                    font.family: "JetBrainsMono Nerd Font"
                                ...
                                Rectangle {
                                    ...
                                    color: confirmYesMa.containsMouse ? root.walColor1 : Qt.rgba(root.walColor1.r, root.walColor1.g, root.walColor1.b, 0.6)
                                    Behavior on color { ColorAnimation { duration: 150 } }
                                    Text { anchors.centerIn: parent; text: "Yes"; color: root.walBackground; font.pixelSize: 15; font.bold: true; font.family: "JetBrainsMono Nerd Font" }
                                    MouseArea {
                                        id: confirmYesMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                        onClicked: { confirmProc.command = ["bash", "-c", powerRow.pendingCmd]; confirmProc.running = true; powerRow.pendingCmd = ""; powerRow.pendingLabel = "" }
                                    }
                                }
                                Rectangle {
                                    width: 60; height: 28; radius: 8
                                    color: confirmNoMa.containsMouse ? Qt.rgba(1,1,1,0.2) : Qt.rgba(1,1,1,0.1)
                                    Behavior on color { ColorAnimation { duration: 150 } }
                                    Text { anchors.centerIn: parent; text: "No"; color: root.walForeground; font.pixelSize: 15; font.bold: true; font.family: "JetBrainsMono Nerd Font" }
                                    MouseArea {
                                        id: confirmNoMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                        onClicked: { powerRow.pendingCmd = ""; powerRow.pendingLabel = "" }
                                    }
                                }
                            }
    ...
    component PowerBtn: Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                if (needsConfirm) {
                    powerRow.pendingCmd = cmd
                    powerRow.pendingLabel = label
                } else {
